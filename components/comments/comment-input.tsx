...
export function CommentInput({ value, onChange, onSend, onKeyDown, sending, charLimit }: CommentInputProps) {
    return (
        <div className="border-t border-border/40 px-3 py-2.5 shrink-0">
            <div className="flex items-stretch gap-2" style={{ height: "34px" }}>
                <div className="relative flex-1 h-full">
                    ...
                    />
                    <span className={`pointer-events-none absolute right-2 top-1/2 -translate-y-1/2 text-[10px] tabular-nums font-medium px-1.5 py-0.5 rounded-md ${value.length >= charLimit
